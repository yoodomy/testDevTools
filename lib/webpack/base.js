...
function getBaseConfig(env) {
    const { mode = 'development', context = process.cwd(), entry = './index.js', platform = process.env.PLATFORM, minimize = mode === 'production', devServer = undefined, bundleFilename = undefined, sourceMapFilename = undefined, assetsPath = undefined, reactNativePath = require.resolve('react-native'), } = env;
    if (!platform) {
    ...
    return {
        ...
        output: {
            ...
            path: node_path_1.default.join(context, 'build/generated', platform),
            filename: 'index.bundle',
            chunkFilename: '[name].chunk.bundle',
            publicPath: devServer ? Repack.getPublicPath({ platform, devServer }) : undefined,
        },
        /**
